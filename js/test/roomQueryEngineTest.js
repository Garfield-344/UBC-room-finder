...
function hammingDistanceTest() {
	...
	pass &= (RoomQueryEngine.hammingDistance("abcdef", "abcdef") == 0);
	console.log("HDT 1: " + pass);
	pass &= (RoomQueryEngine.hammingDistance("abcdeg", "abcdef") == 1);
	console.log("HDT 2: " + pass);
	pass &= (RoomQueryEngine.hammingDistance("abcd", "abcdef") == 2);
	console.log("HDT 3: " + pass);
	pass &= (RoomQueryEngine.hammingDistance("abcdef", "abcd") == 2);
...
function isStringAlmostEqualTest() {
	...
	pass &= (RoomQueryEngine.isStringAlmostEqual("abcdef", "abcdef") == true);
	console.log("ISAET 1: " + pass);
	pass &= (RoomQueryEngine.isStringAlmostEqual("abcdeg", "abcdef") == true);
	console.log("ISAET 2: " + pass);
	pass &= (RoomQueryEngine.isStringAlmostEqual("abcdmn", "abcdef") == false);
	console.log("ISAET 3: " + pass);
	pass &= (RoomQueryEngine.isStringAlmostEqual("abcd", "abcdef") == false);
	console.log("ISAET 4: " + pass);
	pass &= (RoomQueryEngine.isStringAlmostEqual("abcdef", "abcd") == false);
...
function matchesSynonymsTest() {
	let pass = true;
	pass &= (RoomQueryEngine.matchesSynonyms("whiteboard", {"key": "whiteboard", "synonyms": ["whiteboard", "chalkboard"]}) == true);
	console.log("MST 1: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("whoteboard", {"key": "whiteboard", "synonyms": ["whiteboard", "chalkboard"]}) == true);
	console.log("MST 2: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("chalkboard", {"key": "whiteboard", "synonyms": ["whiteboard", "chalkboard"]}) == true);
	console.log("MST 3: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("chalkbarg", {"key": "whiteboard", "synonyms": ["whiteboard", "chalkboard"]}) == false);
	console.log("MST 4: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("woodward", {"key": "Woodward", "synonyms": ["Woodward", "IRC", "WOOD"]}) == true);
	console.log("MST 5: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("wood", {"key": "Woodward", "synonyms": ["Woodward", "IRC", "WOOD"]}) == true);
	console.log("MST 6: " + pass);
	pass &= (RoomQueryEngine.matchesSynonyms("woodywarg", {"key": "Woodward", "synonyms": ["Woodward", "IRC", "WOOD"]}) == false);
...
function exactRoomMatchTest() {
	...
	pass &= (engine.exactRoomMatch(["ikb", "156"], room1) == 100);
	console.log("ERMT 1: " + pass);
	pass &= (engine.exactRoomMatch(["iblc", "156"], room1) == 100);
	console.log("ERMT 2: " + pass);
	pass &= (engine.exactRoomMatch(["wood", "156"], room1) == 0);
	console.log("ERMT 3: " + pass);
	pass &= (engine.exactRoomMatch(["ikb", "200"], room1) == 0);
	console.log("ERMT 4: " + pass);
	pass &= (engine.exactRoomMatch(["wood", "200"], room1) == 0);
...
function scoreRoomByTextQueryTest() {
	...
	// Room + building match
	pass &= (engine.scoreRoomByTextQuery("ikb 156", room1) == 110); 
	console.log("SRBTQT 1: " + pass);
	// Building + quiet match ("silen" is "silent" mispelled)
	pass &= (engine.scoreRoomByTextQuery("ikb silen", room1) == 11); 
	console.log("SRBTQT 2: " + pass);
	// Building + capacity + chalkboard match (No "tv" match, room has no television)
	pass &= (engine.scoreRoomByTextQuery("ikb 6 people tv chalkboard", room1) == 21);
	console.log("SRBTQT 3: " + pass);
	// No match
	pass &= (engine.scoreRoomByTextQuery("irrelevant text", room1) == 0);
